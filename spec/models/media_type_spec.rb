...
# Unit tests for DesignHuddleUser::MediaType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::MediaType do
  let(:instance) { DesignHuddleUser::MediaType.new }

  describe 'test an instance of MediaType' do
    it 'should create an instance of MediaType' do
      expect(instance).to be_instance_of(DesignHuddleUser::MediaType)
    end
  end
