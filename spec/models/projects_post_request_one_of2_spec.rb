...
# Unit tests for DesignHuddleUser::ProjectsPOSTRequestOneOf2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsPOSTRequestOneOf2 do
  let(:instance) { DesignHuddleUser::ProjectsPOSTRequestOneOf2.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf2' do
    it 'should create an instance of ProjectsPOSTRequestOneOf2' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsPOSTRequestOneOf2)
    end
  end
