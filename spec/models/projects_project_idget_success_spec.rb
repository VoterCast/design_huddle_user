...
# Unit tests for DesignHuddleUser::ProjectsProjectIDGETSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDGETSuccess do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDGETSuccess.new }
  ...
  describe 'test an instance of ProjectsProjectIDGETSuccess' do
    it 'should create an instance of ProjectsProjectIDGETSuccess' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDGETSuccess)
    end
  end
