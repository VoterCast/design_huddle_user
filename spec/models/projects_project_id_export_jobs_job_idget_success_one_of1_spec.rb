...
# Unit tests for DesignHuddleUser::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1 do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1' do
    it 'should create an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1)
    end
  end
