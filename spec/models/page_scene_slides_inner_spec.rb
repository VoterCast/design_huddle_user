...
# Unit tests for DesignHuddleUser::PageSceneSlidesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::PageSceneSlidesInner do
  let(:instance) { DesignHuddleUser::PageSceneSlidesInner.new }

  describe 'test an instance of PageSceneSlidesInner' do
    it 'should create an instance of PageSceneSlidesInner' do
      expect(instance).to be_instance_of(DesignHuddleUser::PageSceneSlidesInner)
    end
  end
