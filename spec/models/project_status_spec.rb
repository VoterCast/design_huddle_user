...
# Unit tests for DesignHuddleUser::ProjectStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectStatus do
  let(:instance) { DesignHuddleUser::ProjectStatus.new }

  describe 'test an instance of ProjectStatus' do
    it 'should create an instance of ProjectStatus' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectStatus)
    end
  end
