...
# Unit tests for DesignHuddleUser::ProjectsPOSTRequestOneOf4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsPOSTRequestOneOf4 do
  let(:instance) { DesignHuddleUser::ProjectsPOSTRequestOneOf4.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf4' do
    it 'should create an instance of ProjectsPOSTRequestOneOf4' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsPOSTRequestOneOf4)
    end
  end
