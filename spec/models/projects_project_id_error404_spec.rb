...
# Unit tests for DesignHuddleUser::ProjectsProjectIDError404
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDError404 do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDError404.new }

  describe 'test an instance of ProjectsProjectIDError404' do
    it 'should create an instance of ProjectsProjectIDError404' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDError404)
    end
  end
