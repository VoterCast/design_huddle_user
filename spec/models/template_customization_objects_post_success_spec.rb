...
# Unit tests for DesignHuddleUser::TemplateCustomizationObjectsPOSTSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::TemplateCustomizationObjectsPOSTSuccess do
  let(:instance) { DesignHuddleUser::TemplateCustomizationObjectsPOSTSuccess.new }
  ...
  describe 'test an instance of TemplateCustomizationObjectsPOSTSuccess' do
    it 'should create an instance of TemplateCustomizationObjectsPOSTSuccess' do
      expect(instance).to be_instance_of(DesignHuddleUser::TemplateCustomizationObjectsPOSTSuccess)
    end
  end
