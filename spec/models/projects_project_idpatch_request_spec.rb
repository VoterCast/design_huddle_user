...
# Unit tests for DesignHuddleUser::ProjectsProjectIDPATCHRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDPATCHRequest do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDPATCHRequest.new }
  ...
  describe 'test an instance of ProjectsProjectIDPATCHRequest' do
    it 'should create an instance of ProjectsProjectIDPATCHRequest' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDPATCHRequest)
    end
  end
