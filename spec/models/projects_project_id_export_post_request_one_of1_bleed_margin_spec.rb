...
# Unit tests for DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin' do
    it 'should create an instance of ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin)
    end
  end
