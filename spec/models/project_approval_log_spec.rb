...
# Unit tests for DesignHuddleUser::ProjectApprovalLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectApprovalLog do
  let(:instance) { DesignHuddleUser::ProjectApprovalLog.new }

  describe 'test an instance of ProjectApprovalLog' do
    it 'should create an instance of ProjectApprovalLog' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectApprovalLog)
    end
  end
