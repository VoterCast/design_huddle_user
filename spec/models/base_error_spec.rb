...
# Unit tests for DesignHuddleUser::BaseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::BaseError do
  let(:instance) { DesignHuddleUser::BaseError.new }

  describe 'test an instance of BaseError' do
    it 'should create an instance of BaseError' do
      expect(instance).to be_instance_of(DesignHuddleUser::BaseError)
    end
  end
