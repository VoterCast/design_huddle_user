...
# Unit tests for DesignHuddleUser::ProjectsProjectIDExportPOSTSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDExportPOSTSuccess do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDExportPOSTSuccess.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportPOSTSuccess' do
    it 'should create an instance of ProjectsProjectIDExportPOSTSuccess' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDExportPOSTSuccess)
    end
  end
