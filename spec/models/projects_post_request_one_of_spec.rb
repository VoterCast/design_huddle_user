...
# Unit tests for DesignHuddleUser::ProjectsPOSTRequestOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsPOSTRequestOneOf do
  let(:instance) { DesignHuddleUser::ProjectsPOSTRequestOneOf.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf' do
    it 'should create an instance of ProjectsPOSTRequestOneOf' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsPOSTRequestOneOf)
    end
  end
