...
# Unit tests for DesignHuddleUser::ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData' do
    it 'should create an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData)
    end
  end
