...
# Unit tests for DesignHuddleUser::GalleryTemplatesGETSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::GalleryTemplatesGETSuccess do
  let(:instance) { DesignHuddleUser::GalleryTemplatesGETSuccess.new }

  describe 'test an instance of GalleryTemplatesGETSuccess' do
    it 'should create an instance of GalleryTemplatesGETSuccess' do
      expect(instance).to be_instance_of(DesignHuddleUser::GalleryTemplatesGETSuccess)
    end
  end
