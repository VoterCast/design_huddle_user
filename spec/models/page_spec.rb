...
# Unit tests for DesignHuddleUser::Page
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::Page do
  let(:instance) { DesignHuddleUser::Page.new }

  describe 'test an instance of Page' do
    it 'should create an instance of Page' do
      expect(instance).to be_instance_of(DesignHuddleUser::Page)
    end
  end
