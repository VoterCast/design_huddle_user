...
# Unit tests for DesignHuddleUser::ProjectApprovalStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectApprovalStatus do
  let(:instance) { DesignHuddleUser::ProjectApprovalStatus.new }

  describe 'test an instance of ProjectApprovalStatus' do
    it 'should create an instance of ProjectApprovalStatus' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectApprovalStatus)
    end
  end
