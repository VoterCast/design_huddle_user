...
# Unit tests for DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf3 do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf3.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportPOSTRequestOneOf3' do
    it 'should create an instance of ProjectsProjectIDExportPOSTRequestOneOf3' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf3)
    end
  end
