...
# Unit tests for DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf4 do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf4.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportPOSTRequestOneOf4' do
    it 'should create an instance of ProjectsProjectIDExportPOSTRequestOneOf4' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf4)
    end
  end
