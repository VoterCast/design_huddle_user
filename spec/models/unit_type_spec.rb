...
# Unit tests for DesignHuddleUser::UnitType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::UnitType do
  let(:instance) { DesignHuddleUser::UnitType.new }

  describe 'test an instance of UnitType' do
    it 'should create an instance of UnitType' do
      expect(instance).to be_instance_of(DesignHuddleUser::UnitType)
    end
  end
