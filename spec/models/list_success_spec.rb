...
# Unit tests for DesignHuddleUser::ListSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ListSuccess do
  let(:instance) { DesignHuddleUser::ListSuccess.new }

  describe 'test an instance of ListSuccess' do
    it 'should create an instance of ListSuccess' do
      expect(instance).to be_instance_of(DesignHuddleUser::ListSuccess)
    end
  end
