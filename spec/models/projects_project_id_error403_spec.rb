...
# Unit tests for DesignHuddleUser::ProjectsProjectIDError403
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDError403 do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDError403.new }

  describe 'test an instance of ProjectsProjectIDError403' do
    it 'should create an instance of ProjectsProjectIDError403' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDError403)
    end
  end
