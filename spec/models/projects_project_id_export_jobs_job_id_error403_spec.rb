...
# Unit tests for DesignHuddleUser::ProjectsProjectIDExportJobsJobIDError403
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDExportJobsJobIDError403 do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDExportJobsJobIDError403.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportJobsJobIDError403' do
    it 'should create an instance of ProjectsProjectIDExportJobsJobIDError403' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDExportJobsJobIDError403)
    end
  end
