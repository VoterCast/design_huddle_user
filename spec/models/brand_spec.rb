...
# Unit tests for DesignHuddleUser::Brand
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::Brand do
  let(:instance) { DesignHuddleUser::Brand.new }

  describe 'test an instance of Brand' do
    it 'should create an instance of Brand' do
      expect(instance).to be_instance_of(DesignHuddleUser::Brand)
    end
  end
