...
# Unit tests for DesignHuddleUser::SceneSceneSlidesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::SceneSceneSlidesInner do
  let(:instance) { DesignHuddleUser::SceneSceneSlidesInner.new }

  describe 'test an instance of SceneSceneSlidesInner' do
    it 'should create an instance of SceneSceneSlidesInner' do
      expect(instance).to be_instance_of(DesignHuddleUser::SceneSceneSlidesInner)
    end
  end
