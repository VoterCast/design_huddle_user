...
# Unit tests for DesignHuddleUser::ProjectsPOSTRequestOneOf3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsPOSTRequestOneOf3 do
  let(:instance) { DesignHuddleUser::ProjectsPOSTRequestOneOf3.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf3' do
    it 'should create an instance of ProjectsPOSTRequestOneOf3' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsPOSTRequestOneOf3)
    end
  end
