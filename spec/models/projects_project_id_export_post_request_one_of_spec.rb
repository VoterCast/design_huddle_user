...
# Unit tests for DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf do
  let(:instance) { DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportPOSTRequestOneOf' do
    it 'should create an instance of ProjectsProjectIDExportPOSTRequestOneOf' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsProjectIDExportPOSTRequestOneOf)
    end
  end
