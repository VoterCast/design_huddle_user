...
# Unit tests for DesignHuddleUser::ProjectsPOSTRequestOneOf2Dimensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsPOSTRequestOneOf2Dimensions do
  let(:instance) { DesignHuddleUser::ProjectsPOSTRequestOneOf2Dimensions.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf2Dimensions' do
    it 'should create an instance of ProjectsPOSTRequestOneOf2Dimensions' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsPOSTRequestOneOf2Dimensions)
    end
  end
