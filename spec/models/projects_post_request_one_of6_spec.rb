...
# Unit tests for DesignHuddleUser::ProjectsPOSTRequestOneOf6
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsPOSTRequestOneOf6 do
  let(:instance) { DesignHuddleUser::ProjectsPOSTRequestOneOf6.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf6' do
    it 'should create an instance of ProjectsPOSTRequestOneOf6' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsPOSTRequestOneOf6)
    end
  end
