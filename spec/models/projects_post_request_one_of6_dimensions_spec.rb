...
# Unit tests for DesignHuddleUser::ProjectsPOSTRequestOneOf6Dimensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::ProjectsPOSTRequestOneOf6Dimensions do
  let(:instance) { DesignHuddleUser::ProjectsPOSTRequestOneOf6Dimensions.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf6Dimensions' do
    it 'should create an instance of ProjectsPOSTRequestOneOf6Dimensions' do
      expect(instance).to be_instance_of(DesignHuddleUser::ProjectsPOSTRequestOneOf6Dimensions)
    end
  end
