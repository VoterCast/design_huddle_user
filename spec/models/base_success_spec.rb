...
# Unit tests for DesignHuddleUser::BaseSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleUser::BaseSuccess do
  let(:instance) { DesignHuddleUser::BaseSuccess.new }

  describe 'test an instance of BaseSuccess' do
    it 'should create an instance of BaseSuccess' do
      expect(instance).to be_instance_of(DesignHuddleUser::BaseSuccess)
    end
  end
